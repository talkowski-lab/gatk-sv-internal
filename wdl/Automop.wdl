...
workflow Automop {
    input {
        String workspace_namespace # The namespace (or billing project)of the workspace - e.g. "broad-firecloud-dsde-methods"
        String workspace_name # The name of the workspace - e.g. "GATK-Structural-Variants-Joint-Calling"
        String user # The user who is running the workflow - e.g. "kjaising@broadinstitute.org"
        Boolean dry_run # Whether to dry run the workflow - either "true" or "false"
        String automop_docker # The docker image to use for the workflow - you can use "us.gcr.io/broad-dsde-methods/automop:0.1"
    }
    call MopTask {
        input:
